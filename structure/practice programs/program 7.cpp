...
{
   int p1_counter=0;
    cout<<"Names of all the customers having balance less than $200 "<<endl<<endl;
     for(int i=0;i<2;i++)
    {
      if(c[i].balance<200)
      {
...
{
   int p2_counter=0;
    cout<<"Incremented balance details of all customer already having balance more than $1000 "<<endl<<endl;
     for(int i=0;i<2;i++)
    {
      if(c[i].balance>1000)
      {   
